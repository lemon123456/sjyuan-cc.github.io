...
![]({{ '/assets/img/dojo/ci/shell-executable.png' }})
...
![]({{ '/assets/img/dojo/ci/email-notification.png' }})
...
![]({{ '/assets/img/dojo/ci/system-admin-email-address.png' }})
...
![]({{ '/assets/img/dojo/ci/global-tool-configuration.png' }})
...
![]({{ '/assets/img/dojo/ci/enable-project-based-security.png' }})

不管配置哪一种用户权限，我们使用的`Security Realm`都是`Jenkins’ own user database`:

![]({{ '/assets/img/dojo/ci/access-controll.png' }})
...
![]({{ '/assets/img/dojo/ci/free-style-project.png' }})
...
![]({{ '/assets/img/dojo/ci/basic-config.png' }})
...
![]({{ '/assets/img/dojo/ci/source-code-management.png' }})
...
![]({{ '/assets/img/dojo/ci/build-trigger.png' }})
